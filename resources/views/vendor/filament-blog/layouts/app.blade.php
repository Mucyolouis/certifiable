...
<body class="antialiased">
    <div class="min-h-screen">
        ...
        <!-- Footer -->
        <footer class="w-full px-5 py-12 mt-10 border-t">
            <div class="container mx-auto">
                <div class="mb-4">
                    <div class="grid justify-between gap-x-10 gap-y-10 sm:grid-cols-3">
                        ...
                        <div class="grid col-span-2 sm:grid-cols-2">
                            <div class="grid gap-3 py-3 text-sm font-medium md:flex md:flex-col">
                                            ...
                                            <form method="post" action="{{ route('filamentblog.post.subscribe') }}">
                                                ...
                                                <div class="relative w-100">
                                                    <input autocomplete="email"
                                                        class="flex items-center justify-between w-full px-6 py-5 font-medium text-black bg-white border outline-none rounded-xl placeholder:text-black"
                                                        name="email" value="{{ old('email') }}"
                                                        placeholder="Enter your email" type="email">
                                                    <button type="submit"
                                                        class="absolute -translate-y-1/2 right-4 top-1/2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-primary"
                                                            viewBox="0 0 256 256">
                ...
                <div class="flex flex-wrap items-start justify-center gap-10 pt-5 border-t mt-7 border-slate-200">
                    <div class="text-sm font-medium text-hurricane/50">
                        © 2024 {{ $setting->organization_name ?? 'ECFC Blog' }}. All rights reserved.
                    </div>
                </div>
            </div>
        </footer>
        <div class="fixed bottom-0 left-0 z-50 w-full h-20 bg-white border-t border-gray-200 sm:hidden">
            <div class="grid justify-center h-full max-w-lg grid-cols-2 mx-auto font-medium">
                <a href="{{ route('filamentblog.post.index') }}"
                    class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 mb-1" viewBox="0 0 256 256">
                        <path fill="currentColor"
